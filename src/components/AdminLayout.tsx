...
import { LayoutDashboard, Users, LogOut, Home, Menu, X, MessageSquare, Bell, Shield, Settings, Ticket, History } from 'lucide-react';
...
export function AdminLayout() {
  ...
  const navItems = [
    ...
    { path: '/admin/history', icon: History, label: 'User History' },
