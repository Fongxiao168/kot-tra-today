        ...
        {paymentRequests.length === 0 ? (
          ...
          <>
            ...
            <div className="md:hidden divide-y divide-gray-200 dark:divide-gray-700">
              {paymentRequests.map((request) => (
                <div key={request.id} className="p-4 space-y-3 bg-white dark:bg-gray-800">
                  ...
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <span className="font-medium text-gray-900 dark:text-white">${request.amount}</span>
                  </div>
                  ...
                  <button 
                    onClick={() => setSelectedRequest(request)}
                    className="w-full flex items-center justify-center px-4 py-2 text-sm font-medium text-blue-600 bg-blue-50 rounded-lg hover:bg-blue-100 dark:bg-blue-900/20 dark:text-blue-400 dark:hover:bg-blue-900/40 transition-colors"
                  >
